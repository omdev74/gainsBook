...
const EC_normal: React.FunctionComponent<IEC_normalProps> = (props) => {
    ...
    return (
        <Card className="p-1 md:p-6">
            ...
            <CardFooter className='p-4 flex-col gap-6 text-xs md:text-sm' >
                <div className="w-full flex justify-evenly ">
                    <Button variant="outline" className="text-xs md:text-sm" onClick={addNormalSet}>
                        <Plus className="h-4 w-4 mr-2" /> Add Normal Set
                    </Button>

                    <Button variant="outline" className="text-xs md:text-sm" onClick={toggleDrawer}>
